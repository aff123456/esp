...
data = [{"name": "Esp_Luz", "ip": "1231331231", "ip2": 1233211, "connected": 1, "function":"Luz", "value": 0, "action": 0, "act_value": 0},
        {"name": "Esp_Porta", "ip": "1231311312321", "ip2": 123213132, "connected": 1, "function":"Porta","value": 0, "action": 0, "act_value": 0},
        {"name": "Esp_Ar", "ip": "12311112331", "ip2": 13123, "connected": 1, "function":"Ar","value": 21, "action": 0, "act_value": 16}]

for i in range(len(data)):
    response = requests.put(BASE + "client/" + str(i+3), data[i])
    print(response.json())
